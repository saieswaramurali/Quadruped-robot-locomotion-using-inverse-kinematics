...
# 1 2 6 
def ripple_walk_1(s1, s2, s3, s4, s5, s6, s7, s8, s9) :
    for i in range(len(t1)) :
              delay = 0.05 # before it was 0.5 -> 0.1 ->0.8
              # for first legs 
              s1.angle = -int(t1[i])
              ...
              print(int(-t2[i]))
              # for third legs 
              s3.angle = int(70 - t3[i])
              sleep(delay)
              s6.angle = int(70 - t3[i])
              sleep(delay)
              s9.angle = int(70 - t3[i])
              sleep(delay)
              print(int(t3[i]))
    sleep(0.01) #delay 0.2 ->0.01
# 4 3 5 
def ripple_walk_2(s1, s2, s3, s4, s5, s6, s7, s8, s9) :
    for i in range(len(t1)) :
              delay = 0.05 # before it was 0.5 -> 0.1 ->0.8
              # for first legs 
              s1.angle = int(t1[i])
...
while True :
     ...
     # ripple one
     ripple_walk_1(servo1_1, servo2_1, servo3_1,servo1_2, servo2_2, servo3_2,servo1_6, servo2_6, servo3_6)
     sleep(delay)
     ripple_walk_2(servo1_4, servo2_4, servo3_4,servo1_3, servo2_3, servo3_3,servo1_5, servo2_5, servo3_5)
     sleep(delay)
